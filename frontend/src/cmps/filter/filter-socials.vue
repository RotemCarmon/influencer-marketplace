    ...
    watch: {
        types: {
          ...
          handler(){
            ...
            // console.log('TYPE HAS CHANGED', this.types);
            this.$emit('setTypes', this.types)
          }
        }
    }
}
